...
@section('body-class', 'layout-fixed dark-mode layout-navbar-fixed layout-footer-fixed')
@section('navbar-class', 'navbar-dark')
@push('styles')
    <!-- overlayScrollbars -->
...
@section('content')
    ...
    <div class="content-wrapper">
        <x-content-header title="Dashboard v2" :breadcrumb="['Home','Dashboard v2']"/>
        <!-- Main content -->
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table m-0">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><a href="{{ route('pages.examples.invoice') }}">OR9842</a></td>
                                        ...
                                        <tr>
                                            <td><a href="{{ route('pages.examples.invoice') }}">OR7429</a></td>
                                            <td>iPhone 6 Plus</td>
