...
@section('content')
    ...
    <div class="content-wrapper">
        <x-content-header title="Inbox" :breadcrumb="['Home', 'Mailbox', 'Inbox']"/>
        <!-- Main content -->
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <a href="{{ route('pages.mailbox.compose') }}" class="btn btn-primary btn-block mb-3">Compose</a>
                            ...
                            <div class="table-responsive mailbox-messages">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><a href="{{ route('pages.mailbox.read-mail') }}">Alexander Pierce</a></td>
